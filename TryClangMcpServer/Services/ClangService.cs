...
public class ClangService : IClangService
{
    ...
    public async ValueTask<ClangResult<CompilationResult>> CompileCppAsync(string sourceCode, string options = "-std=c++20 -Wall -Wextra -pedantic")
    {
    ...
    public async ValueTask<ClangResult<AnalysisResult>> AnalyzeCppAsync(string sourceCode, string options = "-std=c++20 -Wall -Wextra -pedantic")
    {
    ...
    public async ValueTask<ClangResult<AstResult>> GetAstAsync(string sourceCode, string options = "")
    {
    ...
    public async ValueTask<ClangResult<PreprocessResult>> PreprocessCppAsync(
        string sourceCode,
    ...
    /// </summary>
    private async ValueTask<ClangResult<T>> ExecuteClangOperationAsync<T>(
        string sourceCode,
        string options,
    ...
    /// </summary>
    private async ValueTask<PreprocessResult> ExecutePreprocessingAsync(
        string sourceFile,
        string[] options,
        string tempDir,
        IReadOnlyDictionary<string, string>? definitions = null)
    ...
    /// </summary>
    private async ValueTask<string> GeneratePreprocessedOutput(
        string sourceFile,
    ...
    /// </summary>
    private async ValueTask<List<string>> ExtractIncludedFilesFromSource(string sourceFile)
    {
